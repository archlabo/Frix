...
set_property PACKAGE_PIN E16 [get_ports RST_IN]
...
set_property PACKAGE_PIN T13 [get_ports PSRAM_ADV_N]
	set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_ADV_N]
##Bank = 14, Pin name = IO_L4P_T0_D04_14,					Sch name = CRAM_CEN
set_property PACKAGE_PIN L18 [get_ports PSRAM_CE_N]
	set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_CE_N]
##Bank = 15, Pin name = IO_L19P_T3_A22_15,					Sch name = CRAM_CRE
#set_property PACKAGE_PIN J14 [get_ports PSRAM_CRE]
	#set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_CRE]
##Bank = 15, Pin name = IO_L15P_T2_DQS_15,					Sch name = CRAM_OEN
set_property PACKAGE_PIN H14 [get_ports PSRAM_OE_N]
	set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_OE_N]
##Bank = 14, Pin name = IO_0_14,								Sch name = CRAM_WEN
set_property PACKAGE_PIN R11 [get_ports PSRAM_WE_N]
	set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_WE_N]
##Bank = 15, Pin name = IO_L24N_T3_RS0_15,					Sch name = CRAM_LBN
set_property PACKAGE_PIN J15 [get_ports PSRAM_LB_N]
	set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_LB_N]
##Bank = 15, Pin name = IO_L17N_T2_A25_15,					Sch name = CRAM_UBN
set_property PACKAGE_PIN J13 [get_ports PSRAM_UB_N]
	set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_UB_N]
##Bank = 14, Pin name = IO_L14P_T2_SRCC_14,					Sch name = CRAM_WAIT
#set_property PACKAGE_PIN T14 [get_ports PSRAM_Wait]
	#set_property IOSTANDARD LVCMOS33 [get_ports PSRAM_Wait]
